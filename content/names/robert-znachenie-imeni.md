...
Имя Роберт уходит корнями в древнегерманскую культуру, образовавшись от слияния двух элементов: *"hrod"* (слава, известность) и *"beraht"* (яркий, блестящий). Таким образом, **значение имени Роберт** можно интерпретировать как *"блестящий от славы"* или *"прославленный"*.
